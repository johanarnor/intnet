...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DescriptionImage'
        db.create_table(u'activities_descriptionimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.Activity'])),
        ))
        db.send_create_signal(u'activities', ['DescriptionImage'])


    def backwards(self, orm):
        # Deleting model 'DescriptionImage'
        db.delete_table(u'activities_descriptionimage')
    ...
    models = {
        ...
        u'activities.descriptionimage': {
            'Meta': {'object_name': 'DescriptionImage'},
            'activity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['activities.Activity']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
